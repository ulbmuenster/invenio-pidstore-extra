...
def add_url(urn: str):
    ...
    return jsonify({
        ...
        "owner": "http://localhost:8000/organisations/id/1",
        "priority": 10,
        "self": request.url + "/urls/base64/" + base64.b64encode(bytes(content["url"], "utf-8")).decode("utf-8"),
    })
              ...
              "items": [
                {
                  ...
                  "owner": "http://localhost:8000/organisations/id/1",
                  "priority": 10,
                  "self": request.url[:find_urls] + "/urls/base64/aHR0cDovL2V4YW1wbGUub3JnL2RvY3VtZW50LXVybA=="
                }
              ],
              "self": request.url
            })
